...
npx google-closure-compiler inject.js > inject.min.js
rm inject.js
mv inject.min.js inject.js
echo '#compile popup.js'
npx google-closure-compiler popup.js > popup.min.js
rm popup.js
mv popup.min.js popup.js
echo '#compile option.js'
npx google-closure-compiler option.js > option.min.js
rm option.js
mv option.min.js option.js
echo '#compile blacklist.js'
npx google-closure-compiler blacklist.js > blacklist.min.js
rm blacklist.js
mv blacklist.min.js blacklist.js
echo '#compile background.js'
npx google-closure-compiler background.js > background.min.js
rm background.js
